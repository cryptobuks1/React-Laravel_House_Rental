                                            ...
                                            <div class="tab-pane" id="seo" role="tabpanel">
                                                    <div class="form-group row col-sm-12">
                                                        ...
                                                        <div class=" input-group">                                                        
                                                            ...
                                                            <input type="text" class="form-control"  name="permalink[slug]" value="{{$page->permalink->slug}}"/>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="tab-pane" id="meta" role="tabpanel">
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            value="{{ isset($post->permalink['seo']['advanced']['canonical']) ? $post->permalink['seo']['advanced']['canonical'] : '' }}"
                                                            >
                                                            <span class="text-danger"></span>
                                                        </div>
